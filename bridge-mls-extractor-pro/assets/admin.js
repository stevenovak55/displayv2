...
(function($) {
    ...
    const BME = {
        ...
        updateLiveProgressDisplay: function(data) {
            ...
            $('#bme-live-current-listing').text(data.current_listing_mls_id ? 
                data.current_listing_mls_id + ' (' + (data.current_listing_address || 'N/A') + ')' : 'N/A');
        ...
        showNotification: function(message, type) {
            ...
            const $notice = $('<div>')
                .addClass('notice notice-' + type + ' is-dismissible bme-notice')

...
require_once BME_PLUGIN_DIR . 'includes/class-bme-security-helper.php';
...
final class Bridge_MLS_Extractor_Pro {
    ...
    public function add_admin_security_headers() {
        ...
        if ($screen && (strpos($screen->id, 'bme') !== false || $screen->post_type === 'bme_extraction')) {
            ...
            BME_Security_Logger::log('security_headers_applied', [
                'screen_id' => $screen->id,

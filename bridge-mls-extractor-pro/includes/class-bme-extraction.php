        ...
        try {
            ...
            do {
                ...
                if (!empty($data['value'])) {
                    ...
                    $processed_info = $this->process_listings($post_id, $batch_listings);
                    $all_processed_info = array_merge($all_processed_info, $processed_info);
                    $total_listings_processed += count($batch_listings);

                    // Update the last modified timestamp from the last item in the batch
            ...
            // Update the last modified time after all batches are done

 ...
 *
 * v3.2.0
 * - FIX: Updated the default fields list to match the latest database schema, including the correction of `RoomsTotal`.
 */
class BME_Admin {
    ...
    public function save_settings_meta_box($post_id) {
        ...
        // The select fields are now informational, so we don't need to save them.

 ...
 *
 * v3.4.0
 * - FEAT: Added a `AdditionalData` LONGTEXT column. This will serve as a "catch-all" to store any non-standard fields from the API as a JSON object, ensuring no data is ever lost.
 */
class BME_DB {

...
class MLD_Rewrites {
    ...
    public function template_include( $template ) {
        if ( get_query_var( 'mls_number' ) ) {
            ...
            // Enqueue Sticky-Kit library from a CDN
            wp_enqueue_script( 'mld-sticky-kit', 'https://cdnjs.cloudflare.com/ajax/libs/sticky-kit/1.1.3/sticky-kit.min.js', ['jquery'], '1.1.3', true );

            // Enqueue your custom script, now dependent on the new library
            wp_enqueue_script( 'mld-single-property-js', MLD_PLUGIN_URL . 'assets/js/single-property.js', ['jquery', 'mld-sticky-kit'], MLD_VERSION, true );

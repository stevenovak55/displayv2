 ...
 *
 * v2.2.0 
 * - FIX: Updated the bathroom filter buttons to match the specified values (Any, 1, 1.5, 2, 2.5, 3+).
 * - FIX: Restored the `render_list_view` shortcode which was previously missing.
 */
class MLD_BME_Shortcodes {
    ...
    public function enqueue_map_assets() {
        ...
        if ( is_a( $post, 'WP_Post' ) && ( has_shortcode( $post->post_content, 'bme_listings_map_view' ) || has_shortcode( $post->post_content, 'bme_listings_half_map_view' ) ) ) {
            ...
            wp_enqueue_style( 'mld-main-css', MLD_PLUGIN_URL . 'assets/css/main.css', [], '2.2.0' );
            wp_enqueue_script( 'mld-map-view-js', MLD_PLUGIN_URL . 'assets/js/map-view.js', [ 'jquery' ], '2.2.0', true );
            ...
            <div id="bme-filters-modal-content">
                ...
                <div id="bme-filters-modal-body">
                    ...
                    <div class="bme-filter-group">
                        ...
                        <div class="bme-checkbox-group" id="bme-filter-listing-type">
                    ...
                    <div class="bme-filter-group">
                        ...
                        <div class="bme-property-details-grid">
                            ...
                            <label>Lot size</label>
                             <div class="bme-filter-row">
                                <input type="number" id="bme-filter-lot-size-min" placeholder="Min acres">
                                <span>-</span>
                                <input type="number" id="bme-filter-lot-size-max" placeholder="Max acres">
                            </div>
    ...
    public function render_list_view() {
        $listings = MLD_BME_Query::get_listings_for_map(0,0,0,0, null, true, false); // Fetch all for list view
        ob_start();
        ?>

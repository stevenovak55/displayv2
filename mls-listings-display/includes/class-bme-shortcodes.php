 ...
 *
 * v2.4.0 
 * - FEAT: Replaced the "For Sale"/"For Rent" toggle with a dropdown menu for better UX.
 */
class MLD_BME_Shortcodes {
    ...
    public function enqueue_map_assets() {
        ...
        if ( is_a( $post, 'WP_Post' ) && ( has_shortcode( $post->post_content, 'bme_listings_map_view' ) || has_shortcode( $post->post_content, 'bme_listings_half_map_view' ) ) ) {
            ...
            wp_enqueue_style( 'mld-main-css', MLD_PLUGIN_URL . 'assets/css/main.css', [], '2.4.0' );
            wp_enqueue_script( 'mld-map-view-js', MLD_PLUGIN_URL . 'assets/js/map-view.js', [ 'jquery' ], '2.4.0', true );
        ...
        <div id="bme-top-bar">
            ...
            <div id="bme-search-controls-container">
                ...
                <div class="bme-mode-select-wrapper">
                    <select id="bme-listing-mode-select" class="bme-control-select">

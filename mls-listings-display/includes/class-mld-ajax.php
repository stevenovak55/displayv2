...
class MLD_Ajax {
    ...
    public function get_filtered_count_callback() {
        ...
        try {
            // The last parameter is is_initial_load, which should be false for a count update.
            $count = MLD_Query::get_listings_for_map( 0, 0, 0, 0, $filters, true, true, false );
    ...
    public function get_map_listings_callback() {
        ...
        try {
            $listings = MLD_Query::get_listings_for_map( $north, $south, $east, $west, $filters, $is_new_filter, false, $is_initial_load );

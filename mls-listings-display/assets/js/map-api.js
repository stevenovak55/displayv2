...
const MLD_API = {
    ...
    refreshMapListings: function(forceRefresh = false) {
        ...
        // This block is reverted to the original behavior from the previous working version.
        // It ensures map bounds are only sent if it's NOT a new filter and NOT a count_only request.
        // This is crucial for the autocomplete to query the full database.

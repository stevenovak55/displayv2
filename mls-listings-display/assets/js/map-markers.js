...
const MLD_Markers = {
    ...
    updateMarkersOnMap: function(listingsInView) {
        ...
        app.markers.forEach(({ marker, id, element, data, rawListingId, baseZIndex }) => {
            ...
            if (!desiredData) {
                ...
                if (needsUpdate) {
                    ...
                    markersToKeep.push({ marker, id, element, data, rawListingId, baseZIndex }); // Keep existing marker
                }
            }
        });
    ...
    createPriceMarker: function(listing, lng, lat, id) {
        ...
        this.createMarkerElement(el, lng, lat, id, listing, 2); // zIndex 2 for price pins
    },
    ...
    createUnitClusterMarker: function(group, lng, lat, id) {
        ...
        this.createMarkerElement(el, lng, lat, id, group, 2); // zIndex 2 for clusters
    },
     ...
     */
    createMarkerElement: function(element, lng, lat, id, data, zIndex = 2) {
        const app = MLD_Map_App;
        let marker;
        ...
        if (bmeMapData.provider === 'google' && app.AdvancedMarkerElement) {
            ...
            element.style.zIndex = zIndex; // Apply z-index for Mapbox

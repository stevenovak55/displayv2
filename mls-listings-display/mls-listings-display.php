...
/**
 * Add the custom rewrite rule for the property details page.
 */
...
/**
 * Add 'mls_number' to the list of query variables WordPress recognizes.
 */
...
/**
 * Flush rewrite rules on plugin activation to ensure our new rule is recognized.
 */
